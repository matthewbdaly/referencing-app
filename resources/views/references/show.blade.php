<x-layout>
            ...
            <main>
                ...
                <div class="bg-white shadow rounded-lg p-6 mb-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button onClick="addNoteModal.showModal()" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Add Note Modal --}}
    <dialog id="addNoteModal" class="fixed inset-0 z-50">
        <div class="fixed inset-0 bg-black opacity-50" onClick="addNoteModal.close()"></div>
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Add Note</h3>
                    <button onClick="addNoteModal.close()" class="text-gray-400 hover:text-gray-500">
                ...
                <form method="POST" action="{{ route('notes.store') }}" class="space-y-4">
                    ...
                    <div>
                        <label for="body" class="block text-sm font-medium text-gray-700 mb-1">Note Content</label>
                        <textarea 
                            id="body" 
                            name="body" 
                            required
                            ...
                            class="w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 invalid:border-red-500 invalid:text-red-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition resize-none"
                        >{{ old('body') }}</textarea>
                    </div>
